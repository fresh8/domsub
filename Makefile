...
s2: subscriber publisher drain
	...
	./subscriber -start 5 -stop 60 -ack 0 > sub2.log # subscriber 2 should see message and ack after ack deadline has passed
	cat sub1.log sub2.log

.PHONY: die
die: subscriber publisher
	./subscriber -start 0 -stop 10 -ack 30 -fail true
